...
image_files = glob.glob("satellite dataset/*.png") + glob.glob("satellite dataset/*.jpg") + glob.glob("planesnet/scenes/scenes/*.png")
image_files = glob.glob("planes dataset/scenes/scenes/*.png")
print(image_files)
...
model.train(data="planes", imgsz=1280, epochs=100)
