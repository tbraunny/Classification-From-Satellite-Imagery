...
class COCOPlanesDataset(Dataset):
    def __init__(self, root_dir, annotation_file, transform=None):
        ...
        self.image_ids = [img_id for img_id in self.coco.getImgIds()
...
def main(train=True):
    ...
    external_test_loader = DataLoader("", batch_size=18, shuffle=False, pin_memory=True, num_workers=10, collate_fn=collate_fn)
    ...
    output_path = "Inference/faster rcnn"
    inference_engine = InferenceEngine(model_path=model_path, num_classes=2, threshold=0.5, output_dir=output_path)
